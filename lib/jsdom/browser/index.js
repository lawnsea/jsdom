define([
    ...
    '../selectors/index', '../level1/core', '../../../node-htmlparser/lib/htmlparser'
],
function (URL, _htmltodom, _domtohtml, _htmlencoding, jsdom, selectors, core) {
    ...
    */
    ...
    var browserAugmentation = exports.browserAugmentation = function(dom, options) {
      ...
      dom.Document.prototype.__defineSetter__('parentWindow', function(win) {
        // XXX: Contextify
        this._parentWindow = win;
      });
